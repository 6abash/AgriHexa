...
STEP files for AgriHexa's mechanical parts, exported from SolidWorks.
More parts land here as they're finalized — this is a first batch, not
the full assembly.
...
elsewhere (e.g. the Simscape model).
